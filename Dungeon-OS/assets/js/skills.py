...
neutralSkillList =\
[SkillData("Attack", 0, 0, False, False, False, False, 1, 0.8, ["damage", "str", 2, 0.2],\
...
SkillData("Reload", 0, 0, False, True, False, False, 1, 100, ["reload"],\
"Remember kids, switching to another skill is faster than reloading.",\
"Reload.",\
["-", "user reloads, ready for another shot."], 0, ""),\
SkillData("Counter", 0, 0, False, False, False, False, 1, 100, ["damage", "str", 1, 0.2],\
...
["Kamikaze", "Overtime"]
beeSkillList =\
[SkillData("Kamikaze", 10, 0, False, False, False, False, 1, 0.8, ["damage", "str", 4, 0.2, "die"],\
...
SkillData("Overtime", 30, 0, False, True, False, False, 1, 100, ["undying", 1],\
...
["The Calling", "Prayer"]
cultistSkillList =\
[SkillData("The Calling", 40, 0, False, False, True, False, 1, 100, ["damage", "FAITH", 2, 0.2, "faith", "loseAll"],\
...
SkillData("Prayer", 20, 0, False, True, False, False, 1, 100, ["pray", 10],\
...
SkillData("Cannon Call", 10, 2, False, True, False, False, 1, 100, ["summon", "Cannon"],\
...
SkillData("Drinks Up!", 5, 0, False, True, False, False, 1, 100, ["drunk", 1, 1, 0, 3],\
...
dissectorSkillList =\
[SkillData("Bloody Jabs", 10, 0, False, False, False, False, 3, 0.7, ["damage", "str", 0.75, 0.2, "bleed", 0.5, 1],
...
SkillData("Bandages", 5, 0, True, False, False, False, 1, 0.9, ["heal", 10, ""],
"Bandages, the medical equivalent of duct tape",
"Heals target for healAmount.",
[["-", "user bandages target up!"]], 60, ""),
SkillData("Puncture", 20, 0, False, False, False, False, 1, 0.8, ["damage", "str", 3.0, 0.2, "buffDuration", "", "buff", "def", -2, "buffEnd"],
...
SkillData("Trade Blows", 15, 0, False, False, False, False, 1, 0.8, 
["cantrip", "damage", "str", 3.0, 0.2, "selfDamage", "str", 2.0, 0.2], 
"Ow for me, more Ows for you!", 
"Cantrip. Deal damageAmount damage, then deal selfDamageAmount damage to self.", 
[["-", "user trades injuries for a stronger strike!"]], 70, ""),
SkillData("Open Wound", 25, 0, False, False, False, False, 1, 0.8, ["bleed", 1.0, 10, "hemotoxin", 1.0, 1], 
...
SkillData("Messy Healing", 15, 0, True, False, False, False, 1, 100, ["bleed", 1.0, 5, "heal", 20, ""],
...
SkillData("Transplant", 35, 0, True, False, False, False, 1, 100, ["selfDamage", "max", 10, "", "heal", ["lastDamage", "user", "lastDamage", "user"], "max"],
...
qiMasterSkillList =\
[SkillData("Crimson Infusion", 5, 0, False, True, False, False, 1, 100, ["cantrip", "infuse", "buff", "str", 1, "crimson", 1, "buffEnd"],\
...
SkillData("Cobalt Infusion", 5, 0, False, True, False, False, 1, 100, ["cantrip", "infuse", "buff", "def", 1, "cobalt", 1, "buffEnd"],\
...
SkillData("On Guard", 5, 0, False, True, False, False, 1, 100, ["cantrip", "counter", 1],\
...
shamanSkillList =\
[SkillData("Bolt", 10, 1, False, False, True, False, 1, 100, ["damage", "str", 2.5, 0.2],\
"Zip! Zap! Zop!",\
"Deal damageAmount damage to all enemies.",\
[["-", "user mutters some words."], ["chant", "user summons LIGHTNING!"]], 50, ""),\
SkillData("Chilling Air", 15, 0, False, False, True, False, 1, 100, ["buffDuration", "", "buff", "str", -1, "spd", -1, "buffEnd"],\
"Ey! Who turned on the AC?",\
"Aall enemies receive strAmount STR and spdAmount SPD",\
[["-", "The air gets colder..."]], 60, ""),\
SkillData("Slippery Sand", 15, 1, False, True, False, False, 1, 100, ["summon", "Slippery Sand"],\
...
bardSkillList =\
[SkillData("Foul Language", 5, 0, False, True, False, False, 1, 100, ["cantrip", "randomTarget", "damage", "str", 3, 0.2],\
"'**** ******.'",\
"deal damageAmount damage to a random target. (Excluding yourself)",\
[["-", "'Your Mother.'"]], 50, ""),\
SkillData("Leer", 10, 0, False, False, False, False, 1, 100, ["taunt", 1, 2],\
"'Even a look pisses you off? Sheesh!'",\
"Inflict TAUNT tauntStacks.",\
[["-", "user looks at target slyly!"]], 40, ""),\
SkillData("Fancy Feet", 10, 0, False, True, False, False, 1, 100, ["buffDuration", 2, "buff", "dodge", 0.25, "buffEnd"],\
